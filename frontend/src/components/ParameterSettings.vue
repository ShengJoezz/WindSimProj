    ...
    <el-form :model="parameters" :rules="rules" ref="formRef" label-width="200px">
      ...
      <el-form-item label="工况">
        <el-form-item label="风向角 (°)" prop="conditions.windDirection" :inline="true">
          <el-input-number v-model="parameters.conditions.windDirection" :min="0" :max="360" style="width: 120px;" />
        </el-form-item>
        <el-form-item label="入口风速 (m/s)" prop="conditions.inletWindSpeed" :inline="true">
          <el-input-number v-model="parameters.conditions.inletWindSpeed" :min="0" style="width: 120px;" />
        </el-form-item>
      </el-form-item>
      ...
      <el-form-item label="网格">
        <el-form-item label="加密区高度 (m)" prop="grid.encryptionHeight" :inline="true">
          <el-input-number v-model="parameters.grid.encryptionHeight" :min="0" style="width: 120px;" />
        </el-form-item>
        <el-form-item label="加密层数" prop="grid.encryptionLayers" :inline="true">
          <el-input-number v-model="parameters.grid.encryptionLayers" :min="0" style="width: 120px;" />
        </el-form-item>
        <el-form-item label="空间网格生长率" prop="grid.gridGrowthRate" :inline="true">
          <el-input-number v-model="parameters.grid.gridGrowthRate" step="0.1" :min="0" style="width: 120px;" />
        </el-form-item>
        <el-form-item label="最大待证长度 (m)" prop="grid.maxExtensionLength" :inline="true">
          <el-input-number v-model="parameters.grid.maxExtensionLength" :min="0" style="width: 120px;" />
        </el-form-item>
        <el-form-item label="加密区径向长度 (m)" prop="grid.encryptionRadialLength" :inline="true">
          <el-input-number v-model="parameters.grid.encryptionRadialLength" :min="0" style="width: 120px;" />
        </el-form-item>
        <el-form-item label="尾流区径向长度 (m)" prop="grid.downstreamRadialLength" :inline="true">
          <el-input-number v-model="parameters.grid.downstreamRadialLength" :min="0" style="width: 120px;" />
        </el-form-item>
        <el-form-item label="加密半径 (m)" prop="grid.encryptionRadius" :inline="true">
          <el-input-number v-model="parameters.grid.encryptionRadius" :min="0" style="width: 120px;" />
        </el-form-item>
        <el-form-item label="加密过渡半径 (m)" prop="grid.encryptionTransitionRadius" :inline="true">
          <el-input-number v-model="parameters.grid.encryptionTransitionRadius" :min="0" style="width: 120px;" />
        </el-form-item>
        <el-form-item label="地形半径 (m)" prop="grid.terrainRadius" :inline="true">
          <el-input-number v-model="parameters.grid.terrainRadius" :min="0" style="width: 120px;" />
        </el-form-item>
        <el-form-item label="地形过渡半径 (m)" prop="grid.terrainTransitionRadius" :inline="true">
          <el-input-number v-model="parameters.grid.terrainTransitionRadius" :min="0" style="width: 120px;" />
        </el-form-item>
        <el-form-item label="尾流区长度 (m)" prop="grid.downstreamLength" :inline="true">
          <el-input-number v-model="parameters.grid.downstreamLength" :min="0" style="width: 120px;" />
        </el-form-item>
        <el-form-item label="尾流区宽度 (m)" prop="grid.downstreamWidth" :inline="true">
          <el-input-number v-model="parameters.grid.downstreamWidth" :min="0" style="width: 120px;" />
        </el-form-item>
        <el-form-item label="缩放比" prop="grid.scale" :inline="true">
          <el-input-number v-model="parameters.grid.scale" step="0.001" :min="0" :max="1" style="width: 120px;" />
        </el-form-item>
      </el-form-item>
      ...
      <el-form-item label="仿真">
        <el-form-item label="核" prop="simulation.cores" :inline="true">
          <el-input-number v-model="parameters.simulation.cores" :min="1" style="width: 120px;" />
        </el-form-item>
        <el-form-item label="步数" prop="simulation.steps" :inline="true">
          <el-input-number v-model="parameters.simulation.steps" :min="1" style="width: 120px;" />
        </el-form-item>
      </el-form-item>
      ...
      <el-form-item label="后处理">
        <el-form-item label="结果层数" prop="postProcessing.resultLayers" :inline="true">
          <el-input-number v-model="parameters.postProcessing.resultLayers" :min="1" style="width: 120px;" />
        </el-form-item>
        <el-form-item label="层数间距 (m)" prop="postProcessing.layerSpacing" :inline="true">
          <el-input-number v-model="parameters.postProcessing.layerSpacing" :min="0" style="width: 120px;" />
        </el-form-item>
        <el-form-item label="各层数据宽度 (m)" prop="postProcessing.layerDataWidth" :inline="true">
          <el-input-number v-model="parameters.postProcessing.layerDataWidth" :min="0" style="width: 120px;" />
        </el-form-item>
        <el-form-item label="各层数据高度 (m)" prop="postProcessing.layerDataHeight" :inline="true">
          <el-input-number v-model="parameters.postProcessing.layerDataHeight" :min="0" style="width: 120px;" />
        </el-form-item>
      </el-form-item>
        
      <el-form-item>
        <el-button type="primary" @click="submitParameters">提交参数</el-button>
      </el-form-item>
    </el-form>
...
const submitParameters = async () => {
  ...
  try {
    ...
    if (response.data.success) {
      ...
      submissionMessage.value = '参数提交成功';
      ElMessage({
        message: '参数提交成功',
        type: 'success'
      });
