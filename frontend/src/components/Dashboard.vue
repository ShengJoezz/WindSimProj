    ...
    >
      <div class="logo-area" :class="{ collapsed: isCollapse }">
        <div class="logo-content">
          <div class="logo-icon">H</div> <!-- Changed W to H for HTwind -->
          <span v-if="!isCollapse" class="logo-text">HTwind</span> <!-- Changed WindSim to HTwind -->
        </div>
      </div>
      ...
      <div class="menu-footer" v-if="!isCollapse">
        <div class="user-status">
          <div class="user-avatar">H</div> <!-- Changed W to H for HTwind -->
          <div class="user-info">
            <div class="user-name">HTwind用户</div> <!-- Changed WindSim to HTwind -->
...
const menuItems = computed(() => {
  ...
  return [
    ...
    { index: `/cases/${caseId.value}/flow-lab`, icon: DataLine, title: "流线粒子实验" },
